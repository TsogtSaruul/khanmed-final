...
const CreateUser = () => {
  ...
  }, [search, currentPage, users, firstIndex, lastIndex, user])
                      ...
                      <div className="col-lg-12">
                        <div className="form-group">
                          <input
                              ...
                              onChange={handleChange}
                          />
                          <button className="button"><i className="fa fa-eye-slash"></i></button>
                          {/* {"password" ==="password" ? (
                              <button
            ...
            <div className="main-sidebar">
              <div className="single-widget search">
                <div className="form">
                  ...
                  <button className="button" onClick={handleSearch}><i className="fa fa-search"></i></button>
                </div>
              </div>
            </div>
          </div>
