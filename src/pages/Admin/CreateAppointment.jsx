...
const CreateAppointment = () => {  
  ...
  }, [search, currentPage, appointments, appointment, firstIndex, lastIndex])
  ...
  const handleSearchByDoctor = () => {
    if (search !== "") {
      ...
      const searchId = searchItem?.map((item) => {return item.id});
            ...
            <div className="main-sidebar">
              <div className="single-widget search">
                <div className="form">
                  ...
                  <button className="button" onClick={handleSearchByPatient}><i className="fa fa-search"></i></button>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="main-sidebar">
              <div className="single-widget search">
                <div className="form">
                  ...
                  <button className="button" onClick={handleSearchByDoctor}><i className="fa fa-search"></i></button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col-12">
            <div className="pagination">
              <ul className="pagination-list">
                ...
                <li>
                  <button onClick={() => setCurrentPage(numberOfPages)}>
